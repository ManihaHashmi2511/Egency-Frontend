      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div>
          <label className="text-base font-medium text-gray-600 flex items-center gap-1.5 mb-1.5">
            <MdOutlinePerson className="text-gray-400 text-xl" /> Full Name
          </label>
          <input
            type="text"
            name="name"
        ...
        <div>
          <label className="text-base font-medium text-gray-600 flex items-center gap-1.5 mb-1.5">
            <MdOutlineMailOutline className="text-gray-400 text-xl" /> Email
          </label>
          <input
            type="email"
            name="email"
        ...
        <div>
          <label className="text-base font-medium text-gray-600 flex items-center gap-1.5 mb-1.5">
            <MdOutlinePhone className="text-gray-400 text-xl" /> Phone
          </label>
          <input
            type="text"
            name="phone"
